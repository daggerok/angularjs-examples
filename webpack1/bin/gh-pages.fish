...
# git init; git remote add origin git@github.com:daggerok/angularjs-examples.git
...
yarn -i; yarn gh-pages
sed -i -e "s/\(<base href=\"\/\">\)/<base href=\"\/angularjs-examples\/\"\/>/g" dist/index.html
